...
export function Workspace({
	...
	return (
		<main className="mj-app-width mx-auto flex min-h-0 w-full min-w-0 flex-1 flex-col px-4 pb-3">
			...
			>
				{!chat.turns.length ? (
					<div className="flex h-full min-h-24 flex-col justify-center gap-2 px-2 py-6">
						<Heading size="card">What shall we make?</Heading>
						<Text size="sm" tone="soft">
							Describe a musical idea. Then ask for changes, one reply at a
							time.
						</Text>
					</div>
				) : (
